...
class BookingController extends Booking{
 public function addBooking($user, $patient,$doctor,$medical){
 	
 	return $this->add($user, $patient,$doctor,$medical);
 }
...
public function Booking(){
	...
	public function updateBooking($bookid,$user, $patient,$doctor,$medical){
		return $this->update($bookid,$user, $patient,$doctor,$medical);
	}
