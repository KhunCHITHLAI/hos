...
{
	private $pdo;
	public function add($user, $patient,$doctor,$medical){
...
public function update($bookid,$user, $patient,$doctor,$medical){
	$this->pdo=Database::connect();
		$this->pdo->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
		//sql query
		$sql="update bookings set userid=:user,patientid=:patient,doctorid=:doctor,medicalconcern=:medical where id=:bid";
		//prepare sql statement
		$stmt=$this->pdo->prepare($sql);
