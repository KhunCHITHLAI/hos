...
<script>
    ...
    {
      $doc=$(this).val();
        $.get("getdate.php",{doc:$doc},function(data){
    ...
    $("#datepicker").datepicker(
        {
			 beforeShowDay: function(day) {
				...
				if(jArray.length==3)
				{
					if(day==jArray[0] || day==jArray[1] || day==jArray[2])
					{
						return [true];
            		} else {
                	return [false];	
				...
				if(jArray.length==3)
				{
					if(day==jArray[0] || day==jArray[1] || day==jArray[2] || day==jArray[3] )
					{
						return [true];
            		} else {
                	return [false];	
				...
				if(jArray.length==4)
				{
					if(day==jArray[0] || day==jArray[1] || day==jArray[2] || day==jArray[3] || day==jArray[4] )
					{
						return [true];
            		} else {
                	return [false];	
				...
				if(jArray.length==5)
				{
					if(day==jArray[0] || day==jArray[1] || day==jArray[2] || day==jArray[3] || day==jArray[4]|| day==jArray[5] )
					{
						return [true];
            		} else {
                	return [false];	
